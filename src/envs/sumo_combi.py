...
class SumoCombi(TwoAgentJunction):
    ...
    def on_road(self, s):
        ...
        if ((x == 1) or (x == 7)) and (y != 4):
            return False
        elif ((x == 2) or (x == 6)) and ((y == 1) or (y == 7)):
            return False
        elif ((x == 3) or (x == 5)) and (y != 2) and (y != 4) and (y != 6):
            return False
    ...
    def traffic_light_violation(self, s, a):
        ...
        if (x == 4) and (y == 3) and (tls == 0) and (a == 3):
            return True
        elif (x == 4) and (y == 5) and (tls == 0) and (a == 1):
            return True
        elif (x == 3) and (y == 4) and (tls == 1) and (a == 2):
            return True
        elif (x == 5) and (y == 4) and (tls == 1) and (a == 4):
            return True
        ...
        with open(file) as f:
            for line in f:
                if line.startswith('row(1)'):
                    ...
                    tls = int(line.split('tls_')[1][0])
                    r = int(line.split('r_')[1][0])
    ...
    def _transition_prob(self, s_from, s_to, a):
        ...
        if ((f_x + a[0]) == t_x) and ((f_y + a[1]) == t_y):
            ...
            if ((t_x == 3) and (t_y == 4)) or ((t_x == 4) and (t_y == 5)) or \
                    ((t_x == 5) and (t_y == 4)) or ((t_x == 4) and (t_y == 3)):
                return 0.25
            elif t_r == 0.0:
                return 0.5
            else:
        ...
        for i in range(self.n_goals):
            for s in range(self.n_states):
                ...
                for j in range(self.n_goals):
                    if (r == 0) and (j != i) and ((x, y) == self.goals[j]):
                        initial[i, s] = 1.0/6
